...
import sys, os, csv, logging, fiona, json
...
fields = {'Longitude*':'LongitudeEntry',
    ...
    'ContentValue*':'ContentValueEntry',
    'HUSBT*':'HUSBTEntry',
    'CensusBlockID':'CensusBlockIDEntry',
...
def analyze():
    ...
    tree.write('settings.xml')
    hpp.HAST_dataPrep()
    popupmsg('Pre-Processing completed. Would you like to go to Analysis?', startAnalysis)
...
def popupmsg(msg, comm):
    ...
    del windowWidth, windowHeight, positionRight, positionDown
    
    popup.mainloop()
    
    
def Analysis():
    popupmsg('Are you sure you want to go to Analysis?', startAnalysis)
